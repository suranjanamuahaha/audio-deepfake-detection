        ...
        <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled
            ...
            <a href="/" className="flex items-center gap-2">
                <img
                    src="../logo.png"
                    alt="Logo"
                    className={`h-8 md:h-10 cursor-pointer transition-all duration-300 ${isScrolled ? "invert" : ""
                        }`}
                />
                <span
                    className={`text-sm md:text-lg font-semibold tracking-wide transition-all duration-300 ${isScrolled ? "text-black" : "text-white/90"
                        }`}
                >
                    DATADEFENDERS
                </span>
